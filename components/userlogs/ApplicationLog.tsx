                        ...
                        <table className="table table-tranx">
                            ...
                            <tbody>
                                <tr className="tb-tnx-item">
                                    ...
                                    <td className="tb-tnx-info">
                                        <div className="tb-tnx-desc">
                                            <span className="title">Pending Loan</span>
                                        </div>
                                    ...
                                    <td className="tb-tnx-amount is-alt">
                                        ...
                                        <div className="tb-tnx-status">
                                            <span className="badge badge-dot bg-warning">Pending</span>
                                        </div>
                                    </td>
                                ...
                                <tr className="tb-tnx-item">
                                    ...
                                    <td className="tb-tnx-info">
                                        <div className="tb-tnx-desc">
                                            <span className="title">Approved Loan</span>
                                        </div>
                                        <div className="tb-tnx-date">
                                ...
                                <tr className="tb-tnx-item">
                                    ...
                                    <td className="tb-tnx-info">
                                        <div className="tb-tnx-desc">
                                            <span className="title">Rejected Loan</span>
                                        </div>
                                        <div className="tb-tnx-date">
                                    ...
                                    <td className="tb-tnx-amount is-alt">
                                        ...
                                        <div className="tb-tnx-status"><span
                                            className="badge badge-dot bg-danger">Rejected</span></div>
                                    </td>
                                    <td className="tb-tnx-action">
                                        <div className="dropdown">
                                            <a className="text-soft dropdown-toggle btn btn-icon btn-trigger"
