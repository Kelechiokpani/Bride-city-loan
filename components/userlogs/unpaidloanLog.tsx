                    ...
                    <div className="card-inner">
                        <div className="card-title-group">
                            <div className="card-title">
                                <h5 className="title">Unpaid  Debts</h5>
                            </div>
                                ...
                                <tr className="tb-tnx-item">
                                    ...
                                    <td className="tb-tnx-amount is-alt">
                                        ...
                                        <div className="tb-tnx-status">
                                            <span className="badge badge-dot bg-warning">Unpaid</span>
                                        </div>
                                    </td>
                                ...
                                <tr className="tb-tnx-item">
                                    ...
                                    <td className="tb-tnx-amount is-alt">
                                        ...
                                        <div className="tb-tnx-status"><span
                                            className="badge badge-dot bg-warning">UnPaid</span></div>
                                    </td>
                                    <td className="tb-tnx-action">
                                        <div className="dropdown">
                                            <a className="text-soft dropdown-toggle btn btn-icon btn-trigger"
