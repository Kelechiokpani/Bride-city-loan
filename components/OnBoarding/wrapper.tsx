                  ...
                  <div className="nk-block-head nk-block-head-lg wide-xs mx-auto">
                      <div className="nk-block-head-content text-center">
                          ...
                          <div className="nk-block-des">
                              <p>Welcome to <strong>Bride City Loan Dashboard</strong>. You are few steps away
                                  to complete your profile. These are required to buy and sell on our platform!
                                  Let’s start!</p>
                          </div>
                      </div>
                  </div>
                                  ...
                                  <div className="card-inner-group h-100">
                                      ...
                                      <div className="card-inner">
                                          <div className="align-center gx-3">
                                              ...
                                              <div className="flex-item">
                                                        <span
                                                            className="sub-text sub-text-sm text-soft">1/4 Completed</span>
                                              </div>
                                          </div>
                                      </div>
                                  </div>
