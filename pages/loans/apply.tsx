                        ...
                        <div className="kyc-app wide-sm m-auto">
                            <div className="nk-block-head nk-block-head-lg wide-xs mx-auto">
                                <div className="nk-block-head-content text-center">
                                    <h2 className="nk-block-title fw-normal">Begin your Loan Application Now</h2>
                                    ...
                                    <div className="nk-kycfm">
                                        ...
                                        <div className="nk-kycfm-content">
                                            ...
                                            <div className="row g-4">
                                                ...
                                                <div className="col-md-6">
                                                    <div className="form-group">
                                                        <div className="form-label-group">
                                                            <label className="form-label">Telegram Username <span
                                                                className="text-danger">*</span></label>
                                                        </div>
                                                        <div className="form-control-group">
                                                            <input type="text"
                                        ...
                                        <div className="nk-kycfm-head">
                                            ...
                                            <div className="nk-kycfm-title">
                                                ...
                                                <p className="sub-title">To verify your identity, please upload any of
                                                    your document.</p>
                                            </div>
                                        </div>
                                            ...
                                            <ul className="nk-kycfm-control-list g-3">
                                                <li className="nk-kycfm-control-item">
                                                    <input className="nk-kycfm-control" type="radio" name="id-proof"
                                                           id="passport" data-title="Passport" defaultChecked={true}/>
                                                ...
                                                <li className="nk-kycfm-control-item">
                                                    <input className="nk-kycfm-control" type="radio" name="id-proof"
                                                           id="national-id" data-title="National ID"/>
                                        ...
                                        <div className="nk-kycfm-footer">
                                            ...
                                            <div className="nk-kycfm-action pt-2">
                                                <button type="submit" className="btn btn-lg btn-primary">Process
                                                    Application
                                                </button>
                                            </div>
                                        </div>
