                          ...
                          <div className="col-md-6">
                            <div className="form-group ">
                              ...
                              <div className="form-control-group">
                                <select
                                  defaultValue={input.packagetype}
                                  {...register("selectpackage")}
                                  className={`form-control form-control-lg  ${
                                    errors.selectpackage ? "is-invalid" : ""
                                  }`}
                            ...
                            <div className="form-group">
                              ...
                              <div className="form-control-group">
                                <select
                                  ...
                                  defaultValue={input.amounttype}
                                  onChange={handleTypeChange}
                                  className={`form-control form-control-lg ${
                                    errors.selectrequirement ? "is-invalid" : ""
                                  }`}
                                >
                                  <option selected></option>
                                ...
                                <div className="invalid-feedback">
                                  {errors.selectrequirement?.message}
                                </div>
                              </div>
                            </div>
                          </div>
                            ...
                            <div className="form-group">
                              ...
                              <div className="form-control-group">
                                <select
                                  ...
                                  defaultValue={input.requirmenttype}
                                  onChange={handleTypeChange}
                                  className={`form-control form-control-lg ${
                                    errors.selectamount ? "is-invalid" : ""
                                  }`}
                                >
                                  <option selected></option>
                            ...
                            <div className="form-group">
                              ...
                              <div className="form-control-group">
                                <select
                                  ...
                                  defaultValue={input.paymenttype}
                                  onChange={handleTypeChange}
                                  className={`form-control form-control-lg ${
                                    errors.selectpayback ? "is-invalid" : ""
                                  }`}
                                >
                                  <option selected></option>
