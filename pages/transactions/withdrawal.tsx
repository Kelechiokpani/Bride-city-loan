...
import WithdrawalLog from "../../components/userlogs/withdrawalLog";
                        ...
                        <div className="nk-block-head nk-block-head-sm">
                            <div className="nk-block-between g-3">
                                <div className="nk-block-head-content">
                                    <h3 className="nk-block-title page-title">Withdrawal History</h3>
                                    <div className="nk-block-des text-soft">
                                        <p>You have a total of 14 Withdrawals.</p>
                                    </div>
                                </div>
